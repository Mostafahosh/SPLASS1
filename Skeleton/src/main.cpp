...
int main(int argc, char** argv){
   ...
   Settlement *s=new Settlement(name,num);
    ...
    FacilityType f= Facility("school",s->getName(),FacilityCategory::LIFE_QUALITY,1,3,2,1);
    Facility f1= Facility("park",s->getName(),FacilityCategory::LIFE_QUALITY,2,4,1,1);
    Facility f2= Facility("office",s->getName(),FacilityCategory::LIFE_QUALITY,3,3,2,2);
    Facility f3= Facility("gym",s->getName(),FacilityCategory::LIFE_QUALITY,3,5,2,1);
